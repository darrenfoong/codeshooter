...
public abstract class ShooterBot {
	...
	protected static final long KEY_DURATION_IN_MS = Long.parseLong(PROPERTIES.getProperty(Properties.BOT_KEY_DURATION_IN_MS));
	protected static final long KEY_WAIT_IN_MS = Long.parseLong(PROPERTIES.getProperty(Properties.BOT_KEY_WAIT_IN_MS));
