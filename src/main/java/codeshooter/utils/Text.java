...
public class Text {
  public static void drawCentreString(
      Graphics2D g2d, String text, Color textColor, float fontSize, int x, int y, int centre) {
  ...
  public static void drawString(
      Graphics2D g2d, String text, Color textColor, float fontSize, int x, int y) {
    g2d.setFont(g2d.getFont().deriveFont(fontSize));
    g2d.setColor(textColor);
